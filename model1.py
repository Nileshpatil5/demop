import pandas as pd
MyData = pd.read_csv(r"C:\Users\Nilesh Patil\Desktop\Velocity New\Flask\Sample projects\prediction_Expense 2\prediction_Expense 2\Income_Expense_Data.csv")
